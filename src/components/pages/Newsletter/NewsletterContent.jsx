...
function NewsletterContent() {
  ...
  return (
    <Container>
      <Title>LIGHTING , PROJECTING AND CONSULTING</Title>
      <Subtitle>
        From consulting on materials to video rendering, from lighting verification through the
        positioning of the lighting bodies.
      </Subtitle>
      <Email>
        <EmailButton>
          <EmailLeft>
